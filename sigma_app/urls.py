...
urlpatterns = [
    ...
    path('user/<str:pk>/insertion_orders/list/', insertion_orders.user_insertion_orders,
    ...
    path('bulk_create_user_insertion_order/', insertion_orders.bulk_create_user_insertion_order,
    ...
    path('bulk_create_campaign_naming_tool/', cnt.bulk_create_campaign_naming_tool,
        name='bulk_create_campaign_naming_tool'),
    path('user/<str:pk>/campaign_naming_tools/list/', cnt.user_campaign_naming_tools,
