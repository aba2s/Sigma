"""
Django settings for sigma_project project.
...
ROOT_URLCONF = 'sigma_project.urls'
...
WSGI_APPLICATION = 'sigma_project.wsgi.application'
...
ADMINISTRATEURS_EMAILS = os.environ.get('ADMINISTRATEURS_EMAILS')